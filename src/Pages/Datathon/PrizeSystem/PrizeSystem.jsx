...
const PrizeSystem = () => {
    const prizes = [
        { title: '🏆 1st Place', reward: '15000 BDT + Certificate' },
        { title: '🥈 2nd Place', reward: '10000 BDT + Certificate' },
        { title: '🥉 3rd Place', reward: '8000 BDT + Certificate' },
        // { title: '🥉 3rd Runner-up', reward: '8000 BDT + Certificate' },
