...
const Footer = () => {
  return (
    <footer className="footer p-10 bg-base-200 text-base-content mt-12 -mb-20">
      <nav>
      ...
      <form>
        <h6 className="footer-title">KUCSE Symposium-2024</h6>
        <h4 className="footer-title text-white">Khulna University</h4>
        <h3 className="footer-title text-white">Computer Science & Enginnering , Discipline</h3>
        <h4 className="footer-tittle text-yellow-300">Contact Us!</h4>
        <h4>Email: <a>head@cse.ku.ac.bd</a></h4>
