...
const PersonCard = ({ schedule, speaker, company, position, topic, linkedin, image }) => {
    return (
        <div className="card bg-[#1a0228] max-w-xs sm:max-w-md md:max-w-lg shadow-2xl shadow-black mx-auto my-4">
            <figure>
                <img className="w-2/3 p-3 md:w-1/2 mx-auto rounded-full  hover-text-xl" src={image} alt={speaker} />
            </figure>
            <div className="card-body bg-slate-950 rounded-b-xl text-start p-4">
