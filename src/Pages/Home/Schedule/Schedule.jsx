...
const Schedule = () => {
  ...
  return (
    <div className="text-center p-8 md:p-16 lg:p-36">
      <p className="text-xl md:text-2xl lg:text-3xl font-semibold text-bold">
        <span className="text-yellow-700">Synergy - X 2024: </span>Time to
        Innovate is Ticking Down!
      </p>
      <p className="text-lg md:text-xl lg:text-2xl font-semibold text-white p-5">
        Join us for a groundbreaking event in tech and ideas!
      </p>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-5 text-center auto-cols-max justify-center">
        <div className="flex flex-col p-2 bg-neutral rounded-box text-neutral-content">
          <span className="countdown font-mono text-4xl md:text-5xl text-white">
            <span style={{ "--value": timeLeft.days }}></span>
          </span>
